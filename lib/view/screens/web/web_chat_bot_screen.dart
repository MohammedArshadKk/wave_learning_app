...
class WebChatBotScreen extends StatefulWidget {
  const WebChatBotScreen({super.key});

  @override
  State<WebChatBotScreen> createState() => _WebChatBotScreenState();
}

class _WebChatBotScreenState extends State<WebChatBotScreen> {
